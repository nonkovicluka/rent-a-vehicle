rentAVehicleApp.controller('UsersController', function ($http, $scope) {
    ...
    var init = function () {
        $http.get('api/users/all').success(function (res) {
            $scope.users = res;
    ...
    var editUser = function () {
        $http.put('api/users/edit', $scope.appUser).success(function (res) {
            $scope.appUser = null;
    ...
    var addUser = function () {
        $http.post('api/users/add', $scope.appUser).success(function (res) {
            $scope.appUser = null;
            $scope.confirmPassword = null;
            $scope.userForm.$setPristine();
